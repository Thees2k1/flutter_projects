          ...
          child: SizedBox(
            ...
            child: Stack(
              children: [
                ...
                if (selected) ...[
                  CenterLeft(child: Image.asset(AssetsPaths.titleSelectedLeft)),
                  CenterRight(
                    child: Image.asset(AssetsPaths.titleSelectedRight),
                  ),
                ],
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Image.asset(AssetsPaths.titleSelectedLeft, height: 65),
            Text('57', style: TextStyles.h2),
            Image.asset(AssetsPaths.titleSelectedRight, height: 65),
          ],
        ...
        return SizedBox(
              ...
              child:
                  Stack(
                        children: [
                          Positioned.fill(
                            child: Image.asset(AssetsPaths.titleStartBtn),
                          ),
                          if (state.isHovered || state.isFocused) ...[
                            Positioned.fill(
                              child: Image.asset(
                                AssetsPaths.titleStartBtnHover,
                              ),
                            ),
                          ],
                          Center(
